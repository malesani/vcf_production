...
const DashboardTecnico: React.FC<DashboardProps> = ({ userName, pageName }) => {
  const rankings = [
  ...
  return (
    <MDBContainer className="py-4">
      <MDBRow>
        {/* ==================== LEFT ==================== */}
        <MDBCol sm="12" md="12" lg="8" className="mb-4">
          {/* === PANORAMICA GLOBALE === */}
          <div>
            <div
              style={{
            ...
            <MDBCard className="p-4 mb-4">
              ...
              <div className="bg-light text-muted d-flex align-items-center justify-content-center rounded-3 mb-5" style={{ width: "100%", height: "200px" }}>
                <ResponsiveLine
                  data={dataGraf}
                    ...
                    <MDBCard className="border-0 bg-light h-100 shadow-0">
                      <MDBCardBody className="p-3 d-flex flex-column justify-content-between">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          <MDBTypography className={`fw-semibold ${item.positive ? "text-success" : "text-danger"} fs-6`}>
                            {item.change}
                          </MDBTypography>

                          <div
                            className={`d-flex align-items-center justify-content-center rounded-3 ${
                              item.positive ? "bg-success bg-opacity-10" : "bg-danger bg-opacity-10"
                            }`}
                            style={{ width: "36px", height: "22px" }}
                          >
                            <MDBIcon fas icon="chart-line" className={item.positive ? "text-success fs-6" : "text-danger fs-6"} />
                          </div>
                        </div>
                      </MDBCardBody>
                    </MDBCard>
                  ...
                  <MDBCard key={i} className="border-0 bg-light mb-3">
                    <MDBCardBody>
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <MDBBtn color={p.color as "success" | "warning"} size="sm">
                          {p.btn}
                        </MDBBtn>
                      </div>
                    </MDBCardBody>
                ...
                <MDBCard key={item.id} className="border-0 bg-light mb-3 p-2 rounded-3">
                  <MDBCardBody className="d-flex align-items-center justify-content-between p-2">
                    ...
                    <div className="text-end">
                      ...
                      <MDBProgress height="6" className="rounded-pill" value={item.progress} color={item.color as any} />
                    </div>
                  </MDBCardBody>
                </MDBCard>
              ))}
