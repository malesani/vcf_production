            ...
            <MDBCard className="p-4 mb-4">
              <div className="overflow-auto" style={{ height: "650px", scrollbarWidth: "none" }}>
                ...
                <div className="mb-3">
                  ...
                  <MDBTypography tag="h6" className="d-inline">Portafogli Gestiti</MDBTypography>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <MDBTypography tag="h6" className="d-inline">Portafogli Personalizzati</MDBTypography>
                </div>
              ...
              {rankings.map((item) => (
                <MDBCard key={item.id} className="border-0 bg-light mb-3 p-2 rounded-3">
                  <MDBCardBody className="d-flex align-items-center justify-content-between p-2">
                    ...
                    <div className="text-end" style={{ minWidth: "" }}>
